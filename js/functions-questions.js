...
const miles = parseInt(prompt("Enter a measurement in miles"));
const kms = convertMilesToKm(miles);
console.log(`${miles} miles is equivalent to ${kms} kms`);
*/
...
const total = addTwoNumbers(num1, num2);
...
const credits = parseInt(prompt("How many credits do you have?"));
if(awardDegree(credits)){
	console.log(`Congratulations, you can be awarded a degree.`);
}else{
...
a) Write a some code that will call this function. Use a forEach loop output the elements of the returned array.
*/
